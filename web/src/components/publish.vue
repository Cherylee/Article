            ...
            <el-col :span="22" :offset="1">
                ...
                <el-form ref="form"  label-position="top" :rules="rules" :model="form" label-width="80px">
                    ...
                    <el-form-item label="正文" prop="content">
                        ...
                        <!-- quill-editor -->
                        <quill-editor v-model="form.content" :options="editorOption" @blur="onEditorBlur($event)" @focus="onEditorFocus($event)" @ready="onEditorReady($event)">
                        </quill-editor>
                    </el-form-item>
                    <el-form-item>
        ...
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    this.$ajax({
                        method: 'get',
                        url: 'http://172.26.151.33:3000/publish',
                        params: {
