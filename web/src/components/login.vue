    ...
    <div>
        <el-row>
            <el-col :span="20" :offset="1">
                <el-form ref="form_login" class="form_login" :rules="rules_login" :model="form_login" label-width="80px">
        ...
        Login(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    this.$ajax({
                        method: 'get',
                        url: 'http://172.26.151.33:3000/login',
                        params: {
                        ...
                        .then((response) => {
                            ...
                            if (res.state == 0) {
                                ...
                                window.localStorage.setItem("username", this.form_login.username);
